"""Civic Records Scribe: Python-first packet analyzer."""
...
PROJECT = {
  "slug": "civic-records-scribe",
  "title": "Civic Records Scribe",
  "version": "2.0.0",
  "tagline": "Transparent extraction manifests for public records and government documents.",
  "problem": "Public records digitization often lacks transparent extraction quality, provenance, and challenge workflows.",
  "solution": "A civic document extraction checker that tracks source authority, fields, confidence, redactions, and appeal-ready audit metadata.",
  "required": [
    "record.agency",
    "record.id",
    "extraction.fields",
